...
export const selectCreateCocktailLoading = (state: RootState) =>
  state.cocktailsReducer.createLoading;
export const selectPublishedCocktails = (state: RootState) => state.cocktailsReducer.publishedItems;
export const selectPublishedCocktailsLoading = (state: RootState) =>
  state.cocktailsReducer.fetchPublishedLoading;
...
export const selectOneCocktailLoading = (state: RootState) =>
  state.cocktailsReducer.fetchOneLoading;
export const selectUsersCocktails = (state: RootState) => state.cocktailsReducer.usersItems;
export const selectUsersCocktailsLoading = (state: RootState) =>
  state.cocktailsReducer.fetchAllUsersLoading;
